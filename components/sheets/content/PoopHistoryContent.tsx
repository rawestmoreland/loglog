...
export interface PoopHistoryContentProps {
  onViewPoop: (poopId: string) => void;
  onClose?: () => void;
}

const PoopHistoryContent = ({ onViewPoop, onClose }: PoopHistoryContentProps) => {
  ...
  return (
    <View className="flex-1">
      ...
      <View className="mb-2 flex-row items-center justify-between p-4">
        <Text className="text-xl font-semibold">Poop History</Text>
        {onClose && (
          <Button
            style={{
...
export default PoopHistoryContent;
